...
button2 = Button( root, text = "Trajectory wit Backspin", command=run_backspin)
def run_both():
    subprocess.call(["python", "Both.py"])
button3 = Button( root, text = "Compare Both", command=run_both)
